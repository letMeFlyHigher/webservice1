 ...
 */
            ...
            /**
            *  GetTongJi_BaoXue bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_BaoXue
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_BaoXue",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_BaoXue",
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_BaoXue parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_BaoXue object =
                new GetTongJi_BaoXue();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_BaoXue".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_BaoXue)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
