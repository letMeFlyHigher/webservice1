 ...
 */
            ...
            /**
            *  GetTongJi_DaFeng bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_DaFeng
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_DaFeng",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_DaFeng",
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_DaFeng parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_DaFeng object =
                new GetTongJi_DaFeng();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_DaFeng".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_DaFeng)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
