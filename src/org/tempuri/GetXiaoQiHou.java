 ...
 */
            ...
            /**
            *  GetXiaoQiHou bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetXiaoQiHou
    ...
    public static class Factory{
        ...
        */
        public static GetXiaoQiHou parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetXiaoQiHou object =
                new GetXiaoQiHou();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetXiaoQiHou".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetXiaoQiHou)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
