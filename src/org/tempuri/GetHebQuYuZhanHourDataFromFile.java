...
/**
 * GetHebQuYuZhanHourDataFromFile.java
 *
 ...
 */
            ...
            /**
            *  GetHebQuYuZhanHourDataFromFile bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetHebQuYuZhanHourDataFromFile
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetHebQuYuZhanHourDataFromFile",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetHebQuYuZhanHourDataFromFile",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetHebQuYuZhanHourDataFromFile",
    ...
    public static class Factory{
        ...
        */
        public static GetHebQuYuZhanHourDataFromFile parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetHebQuYuZhanHourDataFromFile object =
                new GetHebQuYuZhanHourDataFromFile();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetHebQuYuZhanHourDataFromFile".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetHebQuYuZhanHourDataFromFile)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
