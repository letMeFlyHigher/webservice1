 ...
 */
            ...
            /**
            *  GetQiXiangKePu bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetQiXiangKePu
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetQiXiangKePu",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetQiXiangKePu",
    ...
    public static class Factory{
        ...
        */
        public static GetQiXiangKePu parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetQiXiangKePu object =
                new GetQiXiangKePu();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetQiXiangKePu".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetQiXiangKePu)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
