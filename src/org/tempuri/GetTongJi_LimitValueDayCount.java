...
/**
 * GetTongJi_LimitValueDayCount.java
 *
 ...
 */
            ...
            /**
            *  GetTongJi_LimitValueDayCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_LimitValueDayCount
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetTongJi_LimitValueDayCount",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_LimitValueDayCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_LimitValueDayCount",
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_LimitValueDayCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_LimitValueDayCount object =
                new GetTongJi_LimitValueDayCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_LimitValueDayCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_LimitValueDayCount)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
