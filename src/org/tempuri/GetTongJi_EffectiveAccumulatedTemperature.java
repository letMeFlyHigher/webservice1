...
/**
 * GetTongJi_EffectiveAccumulatedTemperature.java
 *
 ...
 */
            ...
            /**
            *  GetTongJi_EffectiveAccumulatedTemperature bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_EffectiveAccumulatedTemperature
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetTongJi_EffectiveAccumulatedTemperature",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for LimitValue
                        */

                        
                                    protected double localLimitValue ;
                           ...
                           */
                           public  double getLimitValue(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param LimitValue
                               */
                               public void setLimitValue(double param){
                            
                                            this.localLimitValue=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_EffectiveAccumulatedTemperature",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_EffectiveAccumulatedTemperature",
                ...
                if (localUserNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://tempuri.org/";
                                    writeStartElement(null, namespace, "limitValue", xmlWriter);
                             
                                               if (java.lang.Double.isNaN(localLimitValue)) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("limitValue cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLimitValue));
                                               }
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_EffectiveAccumulatedTemperature parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_EffectiveAccumulatedTemperature object =
                new GetTongJi_EffectiveAccumulatedTemperature();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_EffectiveAccumulatedTemperature".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_EffectiveAccumulatedTemperature)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","limitValue").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"limitValue" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setLimitValue(
