 ...
 */
            ...
            /**
            *  GetGPSDataById bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetGPSDataById
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetGPSDataById",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetGPSDataById",
    ...
    public static class Factory{
        ...
        */
        public static GetGPSDataById parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetGPSDataById object =
                new GetGPSDataById();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetGPSDataById".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetGPSDataById)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
