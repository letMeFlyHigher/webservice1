 ...
 */
            ...
            /**
            *  GetYuJingXinHaoData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetYuJingXinHaoData
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetYuJingXinHaoData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetYuJingXinHaoData",
    ...
    public static class Factory{
        ...
        */
        public static GetYuJingXinHaoData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetYuJingXinHaoData object =
                new GetYuJingXinHaoData();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetYuJingXinHaoData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetYuJingXinHaoData)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
