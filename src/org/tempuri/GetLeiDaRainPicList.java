 ...
 */
            ...
            /**
            *  GetLeiDaRainPicList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLeiDaRainPicList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetLeiDaRainPicList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetLeiDaRainPicList",
    ...
    public static class Factory{
        ...
        */
        public static GetLeiDaRainPicList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLeiDaRainPicList object =
                new GetLeiDaRainPicList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetLeiDaRainPicList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLeiDaRainPicList)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
