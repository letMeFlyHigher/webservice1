...
/**
 * Get1981_2010HistroyDayData.java
 *
 ...
 */
            ...
            /**
            *  Get1981_2010HistroyDayData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Get1981_2010HistroyDayData
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "Get1981_2010HistroyDayData",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Get1981_2010HistroyDayData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Get1981_2010HistroyDayData",
    ...
    public static class Factory{
        ...
        */
        public static Get1981_2010HistroyDayData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Get1981_2010HistroyDayData object =
                new Get1981_2010HistroyDayData();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Get1981_2010HistroyDayData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Get1981_2010HistroyDayData)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
