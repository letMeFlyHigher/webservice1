 ...
 */
            ...
            /**
            *  GetShuiWenZhanList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShuiWenZhanList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShuiWenZhanList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShuiWenZhanList",
    ...
    public static class Factory{
        ...
        */
        public static GetShuiWenZhanList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShuiWenZhanList object =
                new GetShuiWenZhanList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShuiWenZhanList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShuiWenZhanList)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
