 ...
 */
            ...
            /**
            *  GetTongJi_GanReFeng bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_GanReFeng
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_GanReFeng",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_GanReFeng",
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_GanReFeng parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_GanReFeng object =
                new GetTongJi_GanReFeng();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_GanReFeng".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_GanReFeng)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
