 ...
 */
            ...
            /**
            *  GetTongJi_GanHan bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_GanHan
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_GanHan",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_GanHan",
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_GanHan parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_GanHan object =
                new GetTongJi_GanHan();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_GanHan".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_GanHan)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
