...
/**
 * GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum.java
 *
 ...
 */
            ...
            /**
            *  GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum",
    ...
    public static class Factory{
        ...
        */
        public static GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum object =
                new GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLinJinShengQuYuZhanMinuteDataByQuYuZhanNum)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
