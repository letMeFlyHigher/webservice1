...
/**
 * GetTongJi_AccumulatedTemperature.java
 *
 ...
 */
            ...
            /**
            *  GetTongJi_AccumulatedTemperature bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTongJi_AccumulatedTemperature
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetTongJi_AccumulatedTemperature",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTongJi_AccumulatedTemperature",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTongJi_AccumulatedTemperature",
    ...
    public static class Factory{
        ...
        */
        public static GetTongJi_AccumulatedTemperature parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTongJi_AccumulatedTemperature object =
                new GetTongJi_AccumulatedTemperature();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTongJi_AccumulatedTemperature".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTongJi_AccumulatedTemperature)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
