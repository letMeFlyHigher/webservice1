 ...
 */
            ...
            /**
            *  GetRMAPS_IN_PicList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRMAPS_IN_PicList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetRMAPS_IN_PicList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetRMAPS_IN_PicList",
    ...
    public static class Factory{
        ...
        */
        public static GetRMAPS_IN_PicList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRMAPS_IN_PicList object =
                new GetRMAPS_IN_PicList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetRMAPS_IN_PicList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRMAPS_IN_PicList)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
