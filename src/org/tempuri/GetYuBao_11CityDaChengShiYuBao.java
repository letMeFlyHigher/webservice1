...
/**
 * GetYuBao_11CityDaChengShiYuBao.java
 *
 ...
 */
            ...
            /**
            *  GetYuBao_11CityDaChengShiYuBao bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetYuBao_11CityDaChengShiYuBao
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetYuBao_11CityDaChengShiYuBao",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for ObservDate
                        */

                        
                                    protected java.lang.String localObservDate ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localObservDateTracker = false ;

                           public boolean isObservDateSpecified(){
                               return localObservDateTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getObservDate(){
                               return localObservDate;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ObservDate
                               */
                               public void setObservDate(java.lang.String param){
                            localObservDateTracker = param != null;
                                   
                                            this.localObservDate=param;
                        ...
                        */
                                    ...
                                    protected org.tempuri.ArrayOfString localArrHour ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localArrHourTracker = false ;

                           public boolean isArrHourSpecified(){
                               return localArrHourTracker;
                           }
                           ...
                           * @return org.tempuri.ArrayOfString
                           */
                           public  org.tempuri.ArrayOfString getArrHour(){
                               return localArrHour;
                           }
                            ...
                            /**
                               ...
                               * @param param ArrHour
                               */
                               public void setArrHour(org.tempuri.ArrayOfString param){
                            localArrHourTracker = param != null;
                                   
                                            this.localArrHour=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetYuBao_11CityDaChengShiYuBao",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetYuBao_11CityDaChengShiYuBao",
                ...
                if (localUserNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localArrStationNum.serialize(new javax.xml.namespace.QName("http://tempuri.org/","arrStationNum"),
                                               xmlWriter);
                                        } if (localObservDateTracker){
                                    namespace = "http://tempuri.org/";
                                    writeStartElement(null, namespace, "observDate", xmlWriter);
                             

                                          if (localObservDate==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("observDate cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localObservDate);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localArrHourTracker){
                                            if (localArrHour==null){
                                                 throw new org.apache.axis2.databinding.ADBException("arrHour cannot be null!!");
                                            }
                                           localArrHour.serialize(new javax.xml.namespace.QName("http://tempuri.org/","arrHour"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static GetYuBao_11CityDaChengShiYuBao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetYuBao_11CityDaChengShiYuBao object =
                new GetYuBao_11CityDaChengShiYuBao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetYuBao_11CityDaChengShiYuBao".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetYuBao_11CityDaChengShiYuBao)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","observDate").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"observDate" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setObservDate(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","arrHour").equals(reader.getName())){
                                
                                                object.setArrHour(org.tempuri.ArrayOfString.Factory.parse(reader));
