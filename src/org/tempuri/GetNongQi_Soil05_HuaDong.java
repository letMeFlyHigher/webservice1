 ...
 */
            ...
            /**
            *  GetNongQi_Soil05_HuaDong bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetNongQi_Soil05_HuaDong
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetNongQi_Soil05_HuaDong",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetNongQi_Soil05_HuaDong",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetNongQi_Soil05_HuaDong",
    ...
    public static class Factory{
        ...
        */
        public static GetNongQi_Soil05_HuaDong parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetNongQi_Soil05_HuaDong object =
                new GetNongQi_Soil05_HuaDong();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetNongQi_Soil05_HuaDong".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetNongQi_Soil05_HuaDong)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
