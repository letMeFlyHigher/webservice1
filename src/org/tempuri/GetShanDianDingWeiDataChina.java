...
/**
 * GetShanDianDingWeiDataChina.java
 *
 ...
 */
            ...
            /**
            *  GetShanDianDingWeiDataChina bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShanDianDingWeiDataChina
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetShanDianDingWeiDataChina",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShanDianDingWeiDataChina",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShanDianDingWeiDataChina",
    ...
    public static class Factory{
        ...
        */
        public static GetShanDianDingWeiDataChina parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShanDianDingWeiDataChina object =
                new GetShanDianDingWeiDataChina();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShanDianDingWeiDataChina".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShanDianDingWeiDataChina)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
