 ...
 */
            ...
            /**
            *  GetQuYuZhanHourData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetQuYuZhanHourData
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetQuYuZhanHourData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetQuYuZhanHourData",
    ...
    public static class Factory{
        ...
        */
        public static GetQuYuZhanHourData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetQuYuZhanHourData object =
                new GetQuYuZhanHourData();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetQuYuZhanHourData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetQuYuZhanHourData)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
