 ...
 */
            ...
            /**
            *  GetChinaAllGuoJiaZhan bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetChinaAllGuoJiaZhan
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetChinaAllGuoJiaZhan",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetChinaAllGuoJiaZhan",
    ...
    public static class Factory{
        ...
        */
        public static GetChinaAllGuoJiaZhan parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetChinaAllGuoJiaZhan object =
                new GetChinaAllGuoJiaZhan();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetChinaAllGuoJiaZhan".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetChinaAllGuoJiaZhan)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
